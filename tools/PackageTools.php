...
class PackageTools
{
	...
	#[McpTool(name: 'list_packages', description: 'List packages for an owner (user or org).', inputSchema: ['type' => 'object', 'properties' => ['owner' => ['type' => 'string', 'description' => 'Package owner (user or org)'], 'type' => ['type' => 'string', 'description' => 'Package type filter: generic, container, npm, pypi, etc.'], 'q' => ['type' => 'string', 'description' => 'Search query (optional)'], 'page' => ['type' => 'integer'], 'limit' => ['type' => 'integer'], 'instance' => ['type' => 'string', 'description' => 'Forgejo instance (optional)'], 'user' => ['type' => 'string', 'description' => 'User identity (optional)']], 'required' => ['owner']])]
	...
	#[McpTool(name: 'list_package_files', description: 'List files in a package version.', inputSchema: ['type' => 'object', 'properties' => ['owner' => ['type' => 'string'], 'type' => ['type' => 'string'], 'name' => ['type' => 'string'], 'version' => ['type' => 'string'], 'instance' => ['type' => 'string', 'description' => 'Forgejo instance (optional)'], 'user' => ['type' => 'string', 'description' => 'User identity (optional)']], 'required' => ['owner', 'type', 'name', 'version']])]

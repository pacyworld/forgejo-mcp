...
class OrgTools
{
	...
	#[McpTool(name: 'get_org', description: 'Get organization details.', readOnlyHint: true, inputSchema: ['type' => 'object', 'properties' => ['org' => ['type' => 'string', 'description' => 'Organization name'], 'instance' => ['type' => 'string', 'description' => 'Forgejo instance'], 'user' => ['type' => 'string', 'description' => 'User identity']], 'required' => ['org', 'instance', 'user']])]
	...
	#[McpTool(name: 'delete_org', description: 'Delete an organization. WARNING: Destructive and irreversible.', inputSchema: ['type' => 'object', 'properties' => ['org' => ['type' => 'string', 'description' => 'Organization name'], 'instance' => ['type' => 'string', 'description' => 'Forgejo instance'], 'user' => ['type' => 'string', 'description' => 'User identity']], 'required' => ['org', 'instance', 'user']])]
	...
	#[McpTool(name: 'list_my_orgs', description: 'List organizations the authenticated user belongs to.', readOnlyHint: true, inputSchema: ['type' => 'object', 'properties' => ['page' => ['type' => 'integer'], 'limit' => ['type' => 'integer'], 'instance' => ['type' => 'string', 'description' => 'Forgejo instance'], 'user' => ['type' => 'string', 'description' => 'User identity']], 'required' => ['instance', 'user']])]
	...
	#[McpTool(name: 'list_org_members', description: 'List members of an organization.', readOnlyHint: true, inputSchema: ['type' => 'object', 'properties' => ['org' => ['type' => 'string'], 'page' => ['type' => 'integer'], 'limit' => ['type' => 'integer'], 'instance' => ['type' => 'string', 'description' => 'Forgejo instance'], 'user' => ['type' => 'string', 'description' => 'User identity']], 'required' => ['org', 'instance', 'user']])]
	...
	#[McpTool(name: 'remove_org_member', description: 'Remove a member from an organization.', inputSchema: ['type' => 'object', 'properties' => ['org' => ['type' => 'string'], 'username' => ['type' => 'string'], 'instance' => ['type' => 'string', 'description' => 'Forgejo instance'], 'user' => ['type' => 'string', 'description' => 'User identity']], 'required' => ['org', 'username', 'instance', 'user']])]
	...
	#[McpTool(name: 'list_org_teams', description: 'List teams in an organization.', readOnlyHint: true, inputSchema: ['type' => 'object', 'properties' => ['org' => ['type' => 'string'], 'page' => ['type' => 'integer'], 'limit' => ['type' => 'integer'], 'instance' => ['type' => 'string', 'description' => 'Forgejo instance'], 'user' => ['type' => 'string', 'description' => 'User identity']], 'required' => ['org', 'instance', 'user']])]
	...
	#[McpTool(name: 'remove_team_member', description: 'Remove a user from a team.', inputSchema: ['type' => 'object', 'properties' => ['team_id' => ['type' => 'integer'], 'username' => ['type' => 'string'], 'instance' => ['type' => 'string', 'description' => 'Forgejo instance'], 'user' => ['type' => 'string', 'description' => 'User identity']], 'required' => ['team_id', 'username', 'instance', 'user']])]
	...
	#[McpTool(name: 'remove_team_repo', description: 'Remove a repository from a team.', inputSchema: ['type' => 'object', 'properties' => ['team_id' => ['type' => 'integer'], 'org' => ['type' => 'string'], 'repo' => ['type' => 'string'], 'instance' => ['type' => 'string', 'description' => 'Forgejo instance'], 'user' => ['type' => 'string', 'description' => 'User identity']], 'required' => ['team_id', 'org', 'repo', 'instance', 'user']])]
